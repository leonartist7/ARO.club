...
export const circles = [
  {
    ...
    title: 'Spanish through shared stories',
    state: 'forming',
    detail: 'One more person makes the table feel complete.',
    time: 'Saturday · 11:00 AM',
    place: 'Community Kitchen',
    members: 6,
    capacity: 8,
  },
  {
    ...
    title: 'Repair table: small things, useful hands',
    state: 'confirmed',
    detail: 'The room is ready. Bring one object and your curiosity.',
    time: 'Wednesday · 7:00 PM',
    place: 'The Commons Workshop',
    members: 8,
    capacity: 8,
...
export const findOpportunity = (id) => opportunities.find((opportunity) => opportunity.id === id) ?? opportunities[0];
