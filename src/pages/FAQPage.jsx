...
export default function FAQPage() {
  ...
  const faqs = [
    {
      category: 'general',
      question: 'What is TongueConnect?',
      answer: 'TongueConnect is a platform that connects language learners with native speakers for immersive, real-world language learning experiences. Instead of traditional classes, you learn through activities like cooking classes, walking tours, coffee chats, and more—all led by local teachers in cities worldwide.',
    },
    {
      category: 'general',
      question: 'How is TongueConnect different from language apps or traditional classes?',
    ...
    {
      category: 'teachers',
      question: 'How do I become a teacher on TongueConnect?',
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          >
            ...
            <p className="text-xl text-white/90 max-w-2xl mx-auto">
              Got questions? We've got answers. Find everything you need to know about TongueConnect.
            </p>
          </motion.div>
        </div>
      </div>
