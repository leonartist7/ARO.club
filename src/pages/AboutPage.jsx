        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="text-xl text-white/90 leading-relaxed">
              Langgie was born from a simple idea: the best way to learn a language is
        ...
        <div className="max-w-4xl mx-auto">
          ...
          >
            ...
            <div className="prose prose-lg max-w-none text-gray-700 space-y-4">
              ...
              <p>
                That night, over tapas and wine, they dreamed up Langgie: a platform that
              ...
              <p>
                Today, Langgie operates in over 15 cities worldwide, connecting thousands
