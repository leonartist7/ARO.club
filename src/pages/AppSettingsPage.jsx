        ...
        {copy.settings.rows.map((row) => {
          ...
          return (
            <article key={row.id} data-fv1-setting-row={row.id} className="flex min-h-[92px] min-w-0 flex-wrap items-center gap-4 px-5 py-4 sm:flex-nowrap sm:px-6">
              ...
              <div className="min-w-[10rem] flex-1"><h2 className="text-base font-bold">{row.label}</h2><p data-fv1-essential-copy className="mt-1 text-base leading-6 text-ink/70 dark:text-bone/75">{row.detail}</p></div>
