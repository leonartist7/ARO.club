...
- Version: **0.2.1**, approved 2026-09-08. User-visible behavior, F1–F7 scope, budgets and acceptance thresholds are unchanged from v0.2.0; v0.2.1 narrowly adds the gated CPython 3.13.5 encoder subprofile in section 20. Owner/director: ARO founder/product-design.
