...
| I0 Isolated Infrastructure | **IN-PROGRESS / GATES BLOCKED** | `specs/ARO-I0-ISOLATED-INFRASTRUCTURE.md`, `artifacts/ARO-I0/VERIFICATION.md`, hosted target `mibydnerayobemhnlfyl` | merge/apply default-privilege hardening; complete mandatory local reset, Preview/Auth/recovery and `aro.club` ownership |
