...
| I0 Isolated Infrastructure | **IN-PROGRESS / GATES BLOCKED** | v1.1.1, `specs/ARO-I0-ISOLATED-INFRASTRUCTURE.md`, `artifacts/ARO-I0/VERIFICATION.md`, hosted target `mibydnerayobemhnlfyl`; Preview scopes verified | verify Preview values, then complete Auth/recovery and `aro.club` ownership; local Docker optional |
