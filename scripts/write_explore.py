...
# Read current Explore and rewrite layout structure carefully via full write - keep filter logic
src = Path("src/pages/ExplorePage.jsx").read_text(encoding="utf-8")
# We'll write a full new Explore based on existing logic
Path("src/pages/ExplorePage.jsx").write_text(r'''import { useState, useMemo } from 'react';
...
''', encoding='utf-8')
print('Explore', Path('src/pages/ExplorePage.jsx').stat().st_size)
