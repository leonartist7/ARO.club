...
| B1-I02-repair-within-contract | RUNNING | final B1B test-driver diagnostic candidate is published; final hosted disposable CI is required before review or terminal block | controller validation | composite head `fd169e43d481c9ee25c0ed051659adb7736265b2`; draft PR #52 / B1B-R2 result below | retrieve artifact/evidence or record BLOCKED; independent review only on finished evidence-bearing diff |
...
| B1B-I02-R7-authenticated-CI-mode | REVIEW_READY_PENDING_CI | claim `B1B-R2-20260919-001` completed and published to PR #52; no further repair cycle is authorized | controller validation | PR #52 head `fd169e43d481c9ee25c0ed051659adb7736265b2`; writer result `docs/autonomous-control-20260916/results/B1B-R2-WRITER-RESULT-20260919.md` blob `0d3180386a50c93f7faa21afed19b1807bfe12e6` | final hosted CI, then either artifact verification plus independent review or terminal BLOCKED |
