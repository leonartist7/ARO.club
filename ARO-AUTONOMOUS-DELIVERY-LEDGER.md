...
| B1-I02-repair-within-contract | RUNNING | hosted disposable CI / artifact retrieval for PR #52; candidate remains unaccepted and unreviewed | controller validation | composite head `6c65965758c7c695aecd343d84287e54b0e53d73`; PR #52 / B1B writer result below | retrieve and validate genuine R7 evidence, then independent review |
...
| B1B-I02-R7-authenticated-CI-mode | REVIEW_READY_PENDING_CI | claim `B1B-20260919-001`; immutable published head / draft PR #52; GitHub Actions runs `35430717521` (Quality) and `35430717532` (Isolated database) | controller validation | branch `codex/i02-r7-authenticated-ci-20260919` head `6c65965758c7c695aecd343d84287e54b0e53d73`; durable writer result `docs/autonomous-control-20260916/results/B1B-WRITER-RESULT-20260919.md` blob `f13c35079dd54a593c43bbc175d9c4f0ca7ded6a` | retrieve exact artifact/digest, validate R7 evidence, then independent review |
