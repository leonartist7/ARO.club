...
- FV2/FV3 remain **PROPOSED** until founder product/design approval and post-F7 reconciliation. No runtime or visual implementation dispatch is permitted from them.
...
| B1-I02-repair-within-contract | READY | controller claim; F7 must be inactive/not using host; one product writer | unassigned | immutable main base `79603ae…`; fresh branch/evidence root | append-only repair, focused CI, final independent review |
| B2-I02-R3-retention-amendment | BLOCKED | founder must choose protected Trust-record retention/deletion rule | founder | I02 corrective packet §7 | record decision; no worker infers it |
| C-FV2-preparation | REVIEW_READY | founder approval and final F7 reconciliation before any implementation | founder/product-design | verified external input above | approve/reject proposed v0.2.0; no code task now |
| D-FV3-preparation | REVIEW_READY | founder approval and final F7 reconciliation before any implementation | founder/product-design | verified external input above | approve/reject proposed v0.2.0; no code task now |
...
- **Authority:** `specs/ARO-I0.2-APPLICATION-BASELINE.md` v1.0.0 §§6, 8–13, 16–23; corrected independent review SHA-256 `9778…99467`. R3 is excluded pending B2.
