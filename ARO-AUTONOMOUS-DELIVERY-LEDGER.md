...
| B2-I02-static-failure-diagnosis | CLAIMED | claim `B2-DIAG-20260919-001`; no product writer active | independent read-only SQL reviewer (gpt-5.6-terra, high) | source `/workspace/scratch/95edc6c9ef6a/aro-b2-static-diagnosis-20260919-claim-001/source`; output `/workspace/scratch/95edc6c9ef6a/aro-b2-static-diagnosis-20260919-claim-001/evidence` | distinguish concrete static cause from unavailable hidden CI assertion; no source change |
...
| B2-I02-R3-protected-Trust-repair | REPAIR_REQUIRED | hosted disposable CI passed boundary but failed pgTAP before 91/91; exact CLI diagnostic is deliberately suppressed | controller validation | PR #53 head `b2dd8b6a4afd7299857510fd1d7891feffb6723a`; CI failure result blob `b01ad2653cf5598c1badad94f1d41ef83be1dfa8` | B2-DIAG read-only diagnosis; repair only if exact existing-contract cause is established |
