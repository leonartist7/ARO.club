...
| B1-I02-repair-within-contract | REPAIR_REQUIRED | second R7 hosted browser failure before evidence; final permitted B1B driver diagnostic repair is claimed | B1B repair writer (gpt-5.6-terra, high) | failed head `c502aa378b151bb2651a621628106834184df288`; PR #52 / failure result below | non-sensitive stage/screenshot diagnostic only, final hosted rerun, then review or BLOCKED |
...
| B1B-I02-R7-authenticated-CI-mode | CLAIMED | claim `B1B-R2-20260919-001`; final permitted in-scope test-driver diagnostic repair after second pre-capture failure | B1B repair writer (gpt-5.6-terra, high) | fresh branch from immutable failed head `c502aa378b151bb2651a621628106834184df288`; failure result blob `92c5fa6c14858a062dab4fa332ca7ae50a99a203` | only precise stages + credential-free failure screenshot guard; final hosted rerun must yield retrievable evidence or task becomes BLOCKED |
