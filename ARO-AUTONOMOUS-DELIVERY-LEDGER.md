...
| B1-I02-repair-within-contract | REPAIR_REQUIRED | R7 browser driver failed before evidence; B1B repair cycle 1 is claimed | B1B repair writer (gpt-5.6-terra, high) | failed head `6c65965758c7c695aecd343d84287e54b0e53d73`; PR #52 / result below | focused test-driver repair only, hosted rerun, artifact retrieval, then independent review |
...
| B1B-I02-R7-authenticated-CI-mode | CLAIMED | claim `B1B-R1-20260919-001`; one focused repair cycle of two after hosted DB failure at `BROWSER_ONBOARDING_DRAFT_360_LIGHT` | B1B repair writer (gpt-5.6-terra, high) | branch `codex/i02-r7-authenticated-ci-r1-20260919` from immutable failed head `6c65965758c7c695aecd343d84287e54b0e53d73`; failure result blob `c0732dfc3ef681e0adde8c59d6042e643ec55fb2` | change only browser driver transition synchronization; revalidate local guards/tests, publish one candidate, hosted rerun then independent review |
