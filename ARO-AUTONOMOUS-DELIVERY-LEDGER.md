...
| B2A-I02-boundary-acknowledgement | CLAIMED | claim `B2A-20260919-001`; exact stale expected-list failure revalidated | B2A focused writer (gpt-5.6-terra, high) | base `7f86f07f0d4d8ec7c523f8c4f95e9fa780fefb1f`; fresh isolated source/evidence root | append only B2 migration filename in boundary expected list; boundary test must pass |
...
| B2-I02-R3-protected-Trust-repair | REPAIR_REQUIRED | exact B2 candidate reached static boundary guard failure because new append-only migration is absent from literal expected list | controller validation | candidate `7f86f07f0d4d8ec7c523f8c4f95e9fa780fefb1f`; result blob `6c1d66dca6f79c564ccd40ce78cac8a9d2724de1` | B2A one-file acknowledgement, then republish composite candidate for hosted disposable CI and independent review |
