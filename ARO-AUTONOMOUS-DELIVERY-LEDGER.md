...
| B1-I02-repair-within-contract | RUNNING | B1B repair cycle 2 is active under founder approval; candidate remains unaccepted/unreviewed | B1B writer (gpt-5.6-terra, high) | inherited candidate `998b39b7fc9af32d632882442a53dad47e8710ce`; isolated B1B branch/evidence below | build genuine R7 CI evidence, full validation, then independent review |
...
| B1B-I02-R7-authenticated-CI-mode | RUNNING | claim `B1B-20260919-001`; founder approval recorded; one product writer active | B1B writer (gpt-5.6-terra, high) | branch `codex/i02-r7-authenticated-ci-20260919`; source `/workspace/scratch/95edc6c9ef6a/aro-b1b-20260919-claim-001/source`; evidence `/workspace/scratch/95edc6c9ef6a/aro-b1b-20260919-claim-001/evidence`; approval commit `030ecd1d9b45781a832bf0ce58af051d696262be` | loopback-only CI mode + genuine synthetic evidence; hosted CI then independent review |
