...
| B1-I02-repair-within-contract | REPAIR_REQUIRED | candidate PR #51 needs disposable CI only; it is not accepted or independently reviewed | controller | base `79603ae…`; candidate `998b39b7fc9af32d632882442a53dad47e8710ce`; B1/B1A results `4feff493d22feb94ae8a298a270a99c1e0231e6e` / `295629217a9499bfb322dbe10ed76f11fdf7b1b6` | hosted disposable CI (pgTAP 86/Auth/Storage/browser), then independent review |
